...
const sottostringhe = new Set(
  Object.values(esamiDisponibili).flat()
);
const chiavi = new Set(
  casi.flatMap(d => Object.keys(d))
);

console.log(sottostringhe);
console.log(chiavi);

const soloSottostringhe = [...sottostringhe].filter(x => !chiavi.has(x));
const soloChiavi = [...chiavi].filter(x => !sottostringhe.has(x));

console.log("Solo in sottostringhe:", soloSottostringhe);
console.log("Solo in chiavi:", soloChiavi);
